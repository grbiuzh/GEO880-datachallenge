...
#gruusig ich weiss, schlah mi jetzt nöd mit dene blöde r funktione ume sorry x)
...
deer_01 <- deer_cleaned %>% filter(TierID == "RE01")
deer_02 <- deer_cleaned %>% filter(TierID == "RE02")
deer_03 <- deer_cleaned %>% filter(TierID == "RE03")
